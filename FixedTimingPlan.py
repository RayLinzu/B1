    ...
    'TL_02':{
        ...
        'PLAN':{
            ...
            8:{
                ...
                'Gstate':['rrrrrrrGGGgrrr','GGGgrrrGGGgrrr','rrrrrrrGGGgrrr','rrrrrrrrrrrrrr','rrrrrrrrrrrGGg','rrrrGGgrrrrGGg'],
                'Ystate':['','yyyyrrrGGGgrrr','rrrrrrryyyyrrr','','','rrrryyyrrrryyy'],
                'Rstate':['','rrrrrrrGGGgrrr','rrrrrrrrrrrrrr','','','rrrrrrrrrrrrrr'],
                'PhaseMap':[],
                'PhaseTimeInDuration':[],
                'PhaseDuration':[]
            },
    ...
    'TL_06':{
        ...
        'PLAN':{
            ...
            10:{
                ...
                'Y':[3,0,3],
                'R':[2,0,2],
                'Gstate':['rrrGGgrrrGGg','rrrrrrrrrrrr','GGgrrrGGgrrr'],
                'Ystate':['rrryyyrrryyy','','yyyrrryyyrrr'],
                'Rstate':['rrrrrrrrrrrr','','rrrrrrrrrrrr'],
                'PhaseMap':[0,0,0,1,2,2,2],
                'PhaseTimeInDuration':[73,3,2,30,37,3,2],
                'PhaseDuration':[78,5,2,30,42,5,2]
            }
        }
    },
    ...
    'TL_07':{
        ...
        'PLAN':{
            ...
            8:{
                ...
                'Y':[3,0,3,3,0],
                'R':[2,0,5,5,0],
                'Gstate':['GGrrrrrr','rrrrrGGG','rrGGGGGg','rrrrrGGG','rrrrrrrr'],
                'Ystate':['yyrrrrrr','','rryyyGGg','rrrrryyy',''],
                'Rstate':['rrrrrrrr','','rrrrrGGG','rrrrrrrr',''],
                'PhaseMap':[0,0,0,1,2,2,3,3,3,4],
                'PhaseTimeInDuration':[45,3,2,14,87,3,5,3,5,28],
                'PhaseDuration':[50,5,2,14,95,8,5,13,5,28]
            },
            9:{
                'Phase':4,
                'G':[48,16,82,5],
            ...
            12:{
                ...
                'Rstate':['rrrrrrrr','','rrrrrGGG','rrrrrrrr',''],
                'PhaseMap':[0,0,0,1,2,2,3,3,3,4],
                'PhaseTimeInDuration':[46,3,2,15,85,3,5,3,5,28],
                'PhaseDuration':[51,5,2,15,93,8,41,36,5,28]
            }
        }
    }
}
